        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    ...
                    !$categoria->setImagen($_FILES['inputImgCat'])
                ) {
                    ...
                    $result['fileStatus'] = Validator::saveFile($_FILES['inputImgCat'], $categoria::RUTA_IMAGEN);
                } else {
            ...
            case 'updateRow':
                ...
                if (
                    ...
                    !$categoria->setNombre($_POST['nombreCategoria']) or
                    !$categoria->setDescripcion($_POST['descripcionCategoria']) or
                    !$categoria->setImagen($_FILES['inputImgCat'], $categoria->getFilename())
                ) {
                    $result['error'] = $categoria->getDataError();
                    ...
                    $result['fileStatus'] = Validator::changeFile($_FILES['inputImgCat'], $categoria::RUTA_IMAGEN, $categoria->getFilename());
                } else {
