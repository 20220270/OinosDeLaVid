        ...
        DATA.dataset.forEach(row => {
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mb-4 mt-5 text-center" >
                ...
                <button type="submit" class="btn btn-success mt-1 " id="btnEliminar" name="btnEliminar" onclick="openDelete(${row.id_marca})">
                    ...
                    <button type="reset" class="btn btn-secondary mt-1" id="btnReporte" name="btnReporte" onclick="openReport(${row.id_marca})">
                        <i class="bi bi-x-square-fill"></i>
...
const openReport = (id) => {
    ...
    const PATH = new URL(`${SERVER_URL}reports/admin/marcas_productos.php`);
