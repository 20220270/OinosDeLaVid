...
const SAVE_FORM = document.getElementById('saveForm'),
    ...
    CATEGORIA_PRODUCTO = document.getElementById('selectCategoria');
    MARCA_PRODUCTO = document.getElementById('selectMarca');
    NOMBRE_PRODUCTO = document.getElementById('nombreProducto'),
    DESCRIPCION_PRODUCTO = document.getElementById('descripcionProducto'),
    PRECIO_PRODUCTO = document.getElementById('PrecioProducto'),
    IMAGEN_PRODUCTO = document.getElementById('inputImgProducto'),
    ESTADO_PRODUCTO = document.getElementById('selectEstado');
    CANTIDAD_PRODUCTO = document.getElementById('cantidadProducto'),
    DESCUENTO_PRODUCTO = document.getElementById('descuentoProducto'),
                ...
                <td>${row.id_producto}</td>
                   ...
                   <td>${row.fecha_registro}</td>
                    <td>
                        ...
                        <button type="button" class="btn" onclick="openDelete(${row.id_producto})">
...
const openUpdate = async (id) => {
    ...
    if (DATA.status) {
        ...
        fillSelect(MARCA_API, 'readAll', 'selectMarca', ROW.id_marca);
    } else {
        sweetAlert(2, DATA.error, false);
    }
}
